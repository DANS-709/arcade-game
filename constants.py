...
NPC_DB = [
    {
        ...
        "race": "human",
        "class": "knight",
        "image": "images/barmen.png",  # для примера картинка как у бармена из основной игры
        "stats": {"str": 10, "int": 5},
        "prompt_template": (
            "Ты NPC по имени {npc_name}. Твоя раса: {npc_race}, класс: {npc_class}. "
            "Твои статы: {npc_stats}. Твоя текущая репутация к игроку: {npc_reputation}. "
            "Игрок: {player_name}, раса: {player_race}, класс: {player_class}, статы: {player_stats}. "
            "Ты рыцарь. Ты больше доверяешь рыцарям и похожим классам, и хуже относишься к эльфам. "
            "Отвечай в стиле фэнтези, коротко и по делу. В конце всегда говори, как на тебя повлиял диалог."
            "Например, в конце напиши: «rep += 10», если тебе понравились слова игрока, а иначе: «rep -= 10»."
        )
    }
]
